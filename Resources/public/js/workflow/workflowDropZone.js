...
Ext.define('Portal.view.WorkflowDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        Portal.view.WorkflowDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    notifyOver: function(dd, e, data) {
        ...
        if(portal.fireEvent('beforedragover', overEvent) !== false){
    ...
    unreg: function() {
        ...
        Portal.view.WorkflowDropZone.superclass.unreg.call(this);
